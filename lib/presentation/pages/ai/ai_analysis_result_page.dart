    ...
    return Scaffold(
      ...
      body: BlocBuilder<AIBloc, AIState>(
        builder: (context, state) {
          final List<GeneratedPhoto> photos = (state is GeneratedPhotosLoaded)
              ? state.photos
              : [];
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (widget.analysis.hairAnalysisResult.containsKey('hair_type'))
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: AppColors.elegantGold.withOpacity(0.2),
                      ),
                    ),
                    child: Row(
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget
                                        .analysis
                                        .hairAnalysisResult['hair_type']['type'] ??
                                    '',
                    ...
                    if (photos.isNotEmpty) {
                      try {
                        photo = photos.firstWhere(
                          (p) =>
                              p.styleName?.toLowerCase() ==
                              rec.haircutName.toLowerCase(),
                          orElse: () => photos.length > index
                              ? photos[index]
                              : photos.first, // Fallback to index or first
                        );
                      } catch (_) {
                        // Ignore if not found
                      }
                ...
                ElevatedButton(
                  onPressed: () {
                    final originalImageUrl = widget.analysis.photoId != null
                        ? '${ApiConfig.baseUrl}/photos/${widget.analysis.photoId}'
                        : '';
